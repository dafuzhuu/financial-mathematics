...
\title{金融数学}
\author{教授：林建希\\笔记由Dafu Zhu编写 \\ 基于2025春季厦大数院研究生《金融数学》}
...
\addcontentsline{toc}{section}{衍生产品介绍}
\input{lectures/0-Introduction}

\pagebreak

\section{随机分析}
\input{lectures/01-Stochastic-Calculus}

\pagebreak

\section{期权定价模型}
\input{lectures/02-BSM}
